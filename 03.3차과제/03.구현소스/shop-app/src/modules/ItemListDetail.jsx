...
import "../css/item_list_detail.css";
...
export function ItemListDetail(props) {
...
const addList = () => {
  ...
  let addList = state.state;
  console.log( 'ItemDetail의 장바구니담기',addList)
  localStorage.setItem('shop_cart',JSON.stringify(addList))
              ...
              <div className="itemdetail inbox">
                  ...
                  <b className="chg_num sb_total"></b> */}
                          ...
                          <div className="itemdetail__button__box">
                              <button className="itemdetail__button ib_cart" onClick={()=>addList()}>
                                장바구니 담기
                              </button>
